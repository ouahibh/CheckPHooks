...
const initList =[
{
    ...
    description:'عائلة كي الناس هو فيلم كوميدي جزائري صدر سنة 1990. إخراج عمار تريباش، بطولة عثمان عريوات',
    rate:9,
...
const Movielist = ()=>{
    ...
    const filtrer = ()=>{
        let newList=[];
        if(titlef && ratef){
            newList=movie.filter(movie=>movie.title == titlef && movie.rate == ratef)
        }else if (titlef){
    ...
    return(
        ...
        <Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-title">
                <DialogTitle id="form-dialog-title">Ajouter un nouveau film</DialogTitle>
                <DialogContent>
                    <TextField
                        autoFocus
                        margin="dense"
